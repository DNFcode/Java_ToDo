...
public class RssWriter implements RssWriterInterface {
    
    private static final String XML_BLOCK = "\n";
    ...
    public void write(RssFeedInterface rssfeed, String xmlfile) throws Exception {
        ...
        RssHeaderInterface header = rssfeed.getHeader();
        ...
        Iterator<RssEntryInterface> iterator = rssfeed.getEntries().iterator();
        while (iterator.hasNext()) {
            RssEntryInterface entry = iterator.next();
